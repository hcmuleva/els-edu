...
export const CustomSelect = ({
  ...
  const colorStyles = {
    ...
    blue: {
      button:
        "bg-blue-50 border border-transparent text-blue-700 hover:bg-blue-100",
    ...
    orange: {
      button:
        "bg-orange-50 border border-transparent text-orange-700 hover:bg-orange-100",
    ...
    green: {
      button:
        "bg-emerald-50 border border-transparent text-emerald-700 hover:bg-emerald-100",
  ...
  return (
    <div className={`relative ${className}`} ref={dropdownRef}>
      ...
      {isOpen && (
        <div
          className="absolute top-full left-0 mt-1 min-w-[180px] w-full bg-white rounded-xl shadow-xl border border-border/50 py-1.5 z-[9999] animate-in fade-in zoom-in-95 duration-100 overflow-y-auto [scrollbar-width:none] [-ms-overflow-style:none] [&::-webkit-scrollbar]:hidden"
