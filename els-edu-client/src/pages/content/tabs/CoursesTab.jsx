...
import { useGetList, useGetIdentity, Loading, useDelete, useNotify, useRedirect } from 'react-admin';
import { GraduationCap, Eye, Edit2, Trash2, Search, ArrowUpDown, ArrowUp, ArrowDown, RotateCcw } from 'lucide-react';
...
export const CoursesTab = () => {
    ...
    const { data: courses, isLoading, refetch } = useGetList('courses', {
        ...
        <div className="space-y-6">
            ...
            {isLoading ? (
                ...
                <div className="flex flex-col items-center justify-center h-64 text-center text-muted-foreground p-6 bg-white rounded-b-3xl">
                    ...
                    <p className="text-sm opacity-70 mt-1">Create your first course to get started</p>
                </div>
            ) : (
                    ...
                    <table className="w-full">
                        <thead className="bg-gray-50 border-b border-border/50 sticky top-0 z-10">
                            <tr>
                                ...
                                <th className="px-6 py-4 text-left text-xs font-bold text-gray-600 uppercase tracking-wider">Course Title</th>
