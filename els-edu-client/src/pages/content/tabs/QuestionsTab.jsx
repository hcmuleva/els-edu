...
import { FileQuestion, Eye, Edit2, Trash2, Search, ArrowUpDown, ArrowUp, ArrowDown, X, Info, Calendar, CheckCircle, RotateCcw } from 'lucide-react';
                        ...
                        <div className="flex flex-col gap-1">
                         ...
                         <div className="flex flex-col gap-1">
                            ...
                            <div className="font-bold text-gray-900">
                                <ReferenceField record={question} source="topic.id" reference="topics" link={false}>
...
export const QuestionsTab = () => {
    ...
    const { data: questions, isLoading, refetch } = useGetList('questions', {
        ...
        <div className="space-y-6">
            ...
            {isLoading ? (
                ...
                <div className="flex flex-col items-center justify-center h-64 text-center text-muted-foreground p-6 bg-white rounded-b-3xl">
                    ...
                    <p className="text-sm opacity-70 mt-1">Try adjusting filters or create a new question</p>
                </div>
            ) : (
                                    ...
                                    <tr key={itemId} className="hover:bg-gray-50/50 transition-colors">
                                        ...
                                        <td className="px-6 py-4 align-middle">
                                            <div className="flex items-center justify-end gap-2">
                                                ...
                                                <button
                                                    onClick={() => redirect(`/questions/${itemId}`)}
